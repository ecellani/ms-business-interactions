...
@EqualsAndHashCode(exclude = "businessId")
...
public class ServiceRequestType implements Serializable {
    ...
    @ApiModelProperty(value = "The business id of the service request type")
    private String businessId;

    public ServiceRequestType(String serviceId, String channel, String id, String businessId) {
        this.id = id;
